...
from .v1.role import router as role_router
from .v1.permission import router as permission_router
from .v1.role_permission import router as role_permission_router
